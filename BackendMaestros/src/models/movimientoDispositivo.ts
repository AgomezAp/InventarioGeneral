...
MovimientoDispositivo.init(
  {
    ...
    tipoMovimiento: {
      type: DataTypes.ENUM('ingreso', 'reserva', 'prestamo', 'devolucion', 'cambio_estado', 'actualizacion', 'baja', 'firma_entrega', 'entrada_stock', 'salida_stock', 'retirar_stock', 'conversion_stock', 'cancelacion'),
      allowNull: false,
